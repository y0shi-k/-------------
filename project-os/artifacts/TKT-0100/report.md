...
- `SPEC-0101`〜`SPEC-0112` と `TKT-0101`〜`TKT-0112` を作成し、各ticketの末尾に次のticketを明記した。
- `project-os/knowledge/web-migration-map.md` を索引化し、SPEC/TICKETの対応を一覧化した。
...
- `SPEC-0101`〜`SPEC-0112` の存在確認
- `TKT-0101`〜`TKT-0112` の存在確認
- Web移植ドキュメント内にAPIキー実値らしき文字列がないことの確認
