...
他ユーザーへ公開する前に、`docs/runbook/公開前セキュリティ確認.md` を確認します。

初期公開では、自由な新規登録を閉じ、Supabase Dashboardで管理者がユーザーを作る運用にします。

理由:

- 短いパスワードや捨てメールでの登録を減らすため
- 想定外のユーザーがデータを作るリスクを下げるため
- 公開直後のトラブル調査をしやすくするため
